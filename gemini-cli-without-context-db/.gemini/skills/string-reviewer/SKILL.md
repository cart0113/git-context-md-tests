...
- **No 100% certainty:** Never attribute absolute certainty to model-generated
  content.
- **Precision over fuzziness:** Use technical metrics (latency, tokens, compute)
  instead of "speed" or "cost."
- **Instructional warnings:** Every warning must include a specific corrective
  action (e.g., "Perform a dry-run first" or "Review line 42").
...
Ensure all terminology aligns with the project
[word list](./references/word-list.md).
...
descriptions specifically follow the unique
[Settings guidelines](./references/settings.md).
