...
/**
 * ToolTiming hook input
 */
export interface ToolTimingInput extends HookInput {
  tool_name: string;
  duration_ms: number;
  cached: boolean;
}
...
/**
 * ToolBlocked hook input — fired when the policy engine denies a tool call
 */
