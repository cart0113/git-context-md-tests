...
- **Dependency injection** — `fastapi/dependencies/` module
...
- **OpenAPI generation** — `fastapi/openapi/` module, docs endpoints
- **Security helpers** — `fastapi/security/` module (OAuth2, API keys, HTTP auth)
